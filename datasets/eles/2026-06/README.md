...
demonstrated effect is a large coverage cost.** Read "the deployed choice" language throughout this
section as a physical-compatibility/coverage justification, not a claim that it was shown to improve
`CCT` estimates - it wasn't, on the data checked so far.
